...
class SettingsUI:
    ...
    def calculate_submenu_layout(self, screen_width: int, screen_height: int) -> Optional[Tuple[int, int, int, int]]:
        ...
        self.submenu_total_pages = (len(option_names) + self.submenu_buttons_per_page - 1) // self.submenu_buttons_per_page
    ...
    def _update_main_menu(self, screen_width: int, screen_height: int, 
        ...
        # 计算布局
        available_width, available_height, buttons_per_row, buttons_per_col = self.calculate_main_layout(screen_width, screen_height)
